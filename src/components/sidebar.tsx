...
const brokerLinks = [
  ...
  { href: "/dashboard/standing-orders", label: "Standing Orders", icon: RecurringIcon },
  { href: "/dashboard/providers", label: "Providers", icon: ProviderIcon },
  { href: "/dashboard/complaints", label: "Complaints", icon: ComplaintIcon },
  { href: "/dashboard/reimbursements", label: "Reimbursements", icon: ReimbursementIcon },
...
const providerLinks = [
  ...
  { href: "/dashboard/reimbursements", label: "Invoices", icon: ReimbursementIcon },
];
  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-40 p-2 bg-navy rounded-lg text-white shadow-lg"
      >
      ...
      {/* Mobile sidebar */}
      <aside className={`lg:hidden fixed left-0 top-0 z-50 w-64 bg-navy min-h-screen flex flex-col transform transition-transform duration-200 ${
...
function ReimbursementIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
